...
public class MoonShape : CelestialBodyShape
{
    ...
    void SetCraterSettings(RandomHelper prng, int seed, bool randomizeValues)
    {
        if (randomizeValues)
        {
    ...
    void SetShapeNoiseSettings(RandomHelper prng, bool randomizeValues)
    {
    ...
    void SetRidgeNoiseSettings(RandomHelper prng, bool randomizeValues)
    {
