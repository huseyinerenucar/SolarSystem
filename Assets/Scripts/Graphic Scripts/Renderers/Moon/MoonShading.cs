...
public class MoonShading : CelestialBodyShading
{
    ...
    public Vector2 radiusMinMax = new(0.02f, 0.1f);
    ...
    public override void SetTerrainProperties(Material material, Vector2 heightMinMax, float bodyScale)
    {
        ...
        var prng = new RandomHelper(seed);

        if (randomize)
        {
            SetColors(prng, material);
    ...
    void SetBiomeSettings(RandomHelper prng, Material material)
    {
    ...
    void SetColors(RandomHelper rand, Material material)
    {
    ...
    void SetShadingNoise()
    {
        ...
        RandomHelper prng = new(seed);
        RandomHelper prng2 = new(seed);
        if (randomize)
        {
    ...
    {
        RandomHelper random = new RandomHelper(ejectaRaySeed);
